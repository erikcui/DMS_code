...
public:
	SensorData()
		...
		, m_pEventPicMultiSlice(NULL)
		, m_pEventPicMultiSliceDirection(NULL)
		, m_pEventPicMultiSliceSpeed(NULL)
		, m_nRow(0)
		, m_nColumn(0)
		, m_nBrightness(0)
		, m_nTime(0)
	...
	inline void setEventPicMultiSlice(unsigned char* buffer) { m_pEventPicMultiSlice = buffer; }
	inline void setEventPicMultiSliceDirection(unsigned char* buffer) { m_pEventPicMultiSliceDirection = buffer; }
	inline void setEventPicMultiSliceSpeed(unsigned char* buffer) { m_pEventPicMultiSliceSpeed = buffer; }
	...
	inline unsigned char* getEventPicMultiSlice() { return m_pEventPicMultiSlice; }
	inline unsigned char* getEventPicMultiSliceDirection() { return m_pEventPicMultiSliceDirection; }
	inline unsigned char* getEventPicMultiSliceSpeed() { return m_pEventPicMultiSliceSpeed; }
...
private:
	...
	unsigned char*    m_pEventPicMultiSlice;
	unsigned char*    m_pEventPicMultiSliceDirection;
	unsigned char*    m_pEventPicMultiSliceSpeed;
	int               m_nRow;
	int               m_nColumn;
	int               m_nBrightness;
	int               m_nTime;
...
public:
    ...
    void setTimeBlock(uint32_t msec); //unit: millisecond
    uint32_t getTimeBlock();
	...
	unsigned char* getMultiSliceBuffer();
	unsigned char* getMultiSliceDirectionBuffer();
	unsigned char* getMultiSliceSpeedBuffer();
